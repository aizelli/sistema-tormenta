...
export class InventoryItemController {
  ...
  @Get(':inventoryId/:itemId/:quantity')
  addItemToInventory(@Param('inventoryId') inventoryId: string, @Param('itemId') itemId: string, @Param('quantity') quantity: string) {
    return this.inventoryItemService.addItemToInventory(+inventoryId, +itemId, +quantity);
  }
}
